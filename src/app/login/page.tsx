                    ...
                    {!isForgotPassword && (
                        <div className="mb-6 space-y-4">
                            <button
                                ...
                                disabled={loading}
                                className="w-full py-3.5 px-4 rounded-xl border border-white/10 hover:bg-white/5 disabled:opacity-50 transition-all flex items-center justify-center gap-3 relative overflow-hidden group"
                            >
