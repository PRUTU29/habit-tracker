    ...
    return (
        <div className="relative h-full w-full">
            ...
            <div className="relative z-10 flex h-full flex-col justify-end p-5">
                <div className="truncate text-xl font-bold text-white tracking-tight drop-shadow-md">
                    {item.title}
                </div>
                {item.description ? (
                    <div className="mt-1 line-clamp-2 text-sm text-white/90 font-medium pb-2 drop-shadow-sm">
                        {item.description}
                    </div>
                ) : null}
            </div>
